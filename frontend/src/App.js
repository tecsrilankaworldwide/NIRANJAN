          ...
          <div className="flex items-center space-x-6">
            ...
            {isStudent && (
              <>
                ...
                <a href="/quizzes" className="hover:text-purple-200 transition-colors">📝 Quizzes</a>
                <a href="/achievements" className="hover:text-purple-200 transition-colors">🏆 Achievements</a>
