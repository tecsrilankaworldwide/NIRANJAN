...
// Import Analytics Dashboard component
import AnalyticsDashboardComponent from './pages/AnalyticsDashboard';

// Analytics Dashboard with Navigation
...
// Import Learning Path component
import LearningPathComponent from './pages/LearningPath';

// Learning Path with Navigation
const LearningPath = () => {
  return (
    <div>
      <Navigation />
...
// Subscription page with Navigation
